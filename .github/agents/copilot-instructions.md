# InvisiGuard Development Guidelines
...
- Python 3.11+ (Backend), Node.js/React 18 (Frontend) + FastAPI, OpenCV, NumPy, SciPy (Backend); Vite, Tailwind (Frontend) (003-fix-verify-polish)
- Local filesystem (temp storage) (003-fix-verify-polish)
